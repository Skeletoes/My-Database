...
def gpu_edit():
    dbEdit = sqlite3.connect("myfirstdb.db")
...
def lookup(): # Create a function for the lookup feature
    dbMain = sqlite3.connect('myfirstdb.db') # Create a variable that connects to the database
...
def add_gpu():
    ...
    dbAdd = sqlite3.connect('myfirstdb.db')
            ...
            if gpu_delete == 'QUIT':
                ...
                for deletable_gpus in results:
                    if gpu_delete == deletable_gpus[1]:
                        ...
                        dbDelete = sqlite3.connect('myfirstdb.db')
...
def user_login():
    ...
    dbLogin = sqlite3.connect('myfirstdb.db')
    ...
    while True:
        try:
            ...
            if len(username) < 5:
                ...
                dbUser_add = sqlite3.connect("myfirstdb.db")
...
def gpu_application():
    dbRS = sqlite3.connect("myfirstdb.db")
